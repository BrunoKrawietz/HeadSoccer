...
function createCylinderMesh(segments = 32) {
    ...
    for (let i = 0; i <= segments; i++) {
        ...
        textureCoordinates.push(u, 0, u, 1);
    ...
    for (let i = 0; i <= segments; i++) {
        ...
        normals.push(0, 0, 1);
        textureCoordinates.push(0.5 + 0.5 * Math.cos(angle), 0.5 + 0.5 * Math.sin(angle));
...
function createGoalPostMesh() { return createBoxMesh(); }
function createPlayerBodyMesh() { return createBoxMesh(); }
function createPlayerHeadMesh() { return createSphereMesh(32, 16); }
function createBallMesh() { return createSphereMesh(40, 20); }
function createPowerUpMesh() { return createCylinderMesh(32); }